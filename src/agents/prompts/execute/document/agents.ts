...
- [ARCHITECTURE DIRECTORIES]: For each primary sub-system include bullet point list path to sources of system relative to project root in format: - \`**[SYSTEM NAME]**: [Technology] @ [primary source location relative to project root]\`
...
## Rules 
- If you are unsure or unclear about an item: remove item or section from \`AGENTS.md\` - No guessing, only keep facts and relevant content
